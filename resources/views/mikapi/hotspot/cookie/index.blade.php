...
@push('js')
    ...
    <script>
        ...
        var table = $('#tableData').DataTable({
            ...
            serverSide: false,
            ajax: {
                url: "{{ route('api.mikapi.hotspot.cookies.index') }}",
                data: function(dt) {
                    dt.dt = 'on'
        ...
        $('#btn_delete').click(function() {
            delete_batch("{{ route('api.mikapi.hotspot.cookies.destroy.batch') }}" + param_router)
        })

        multiCheck(table);

        var id;
        var url_put = "{{ route('api.mikapi.hotspot.cookies.destroy.batch') }}/" + id + param_router;
        var url_delete = "{{ route('api.mikapi.hotspot.cookies.destroy', '') }}/" + id + param_router;

        $('#tableData tbody').on('click', 'tr td:not(:first-child)', function() {
            id = table.row(this).id()
            url_put = "{{ route('api.mikapi.hotspot.cookies.destroy.batch') }}/" + id + param_router;
            url_delete = "{{ route('api.mikapi.hotspot.cookies.destroy', '') }}/" + id + param_router;
            edit(true)
        });
